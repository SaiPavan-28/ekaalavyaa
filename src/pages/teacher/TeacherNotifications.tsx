...
export const TeacherNotifications: React.FC = () => {
  const [notifications, setNotifications] = useState(() =>
    portalService.getNotifications().filter((n) => n.role === 'teacher' || n.role === 'all')
  );
  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold font-serif text-[#1C1917]">Faculty Bulletins & Administrative Alerts</h1>
          <p className="text-xs text-[#57534E] mt-1">
            Exam scheduling notices, center coordinator messages, and syllabus circulars.
          </p>
        </div>
      </div>
